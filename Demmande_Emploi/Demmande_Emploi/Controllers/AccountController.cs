...
namespace Demmande_Emploi.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private readonly UserManager<AppUsers> _manager;
        private readonly SignInManager<AppUsers> _signInManager;
        private readonly RoleManager<IdentityRole> _roleManager;

        public AccountController(ApplicationDbContext db, UserManager<AppUsers> manage,
        ...
        public async Task<IActionResult> Login(LoginModels model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (roleName != null)
                {
                    ...
                    AddCookies(user.UserName, roleName, user.Id, model.Remember, user.Email);
                }
                return Ok();
            }
